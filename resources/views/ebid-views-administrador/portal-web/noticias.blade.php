                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card text-white mb-3 bg-primary">
                            <div class="card-header bg-primary" style="font-size: 30px;">PORTAL WEB - ADMINISTRACION DE NOTICIAS</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-table-border-none" id="recent-orders">
                    <div class="card-header">
                        ...
                        <div class="col-md-3"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#crearModal">
                            <span class="mdi mdi-comment-plus"></span>&nbsp;Crear nueva noticia
                        </button></div>
                    </div>
                    <div class="card-body">
                        <table id="noticias" class="table card-table table-responsive" style="width:100%; ">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Titulo de noticia</th>
                                    <th>Perteneciente a</th>
                                    <th>Estado de noticia</th>
                                    <th colspan="2" style="display: none;"></th>
                                    <th>Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($arrayAux[2] as $noticia)
                                <tr>
                                    ...
                                    @foreach($arrayAux[1] as $subd)
                                        ...
                                        @endif
                                    @endforeach
                                    <td style="display: none;">{{ $noticia->not_imagen }}</td>
                                    <td style="display: none;">{{ $noticia->not_historia }}</td>
                                    <td class="">
