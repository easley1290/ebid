                  ...
                  <div class="col-12">  
                    <div class="row">
                            <div class="col-md-12">
                                <div class="card text-white mb-3 bg-primary">
                                    <div class="card-header bg-primary" style="font-size: 30px;">PORTAL WEB - ADMINISTRACIÓN DE NOTAS PARA LAS MATERIAS ASIGNADAS</div>
                                </div>
                            </div>
                    </div>                 
                        <!-- Recent Order Table -->
                    <div class="card card-table-border-none" id="recent-orders">
                        <div class="card-header">
                                <div class="col-md-9"><h2 class="row">Materias asginadas </h2></div>
              ...
              <div class="modal-dialog  modal-xl">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Lista de estudiantes de la materia</h5>
                      ...
                      <div class="row">
                        <table id="notas" class="table card-table table-responsive table-responsive-large" style="width:100%">
                                            <thead>
                                                ...
                                                <th style="display:none">nota_mate_id</th>
                                                <th>nota_examen1</th>
                                                <th>nota_examen2</th>
                                                <th>nota_examen3</th>
                                                <th>Nota final</th>
                                            ...
                                            <tbody>
                                              @foreach($aux[0] as $nota)
                                                <tr>
                                                    ...
                                                    <td>{{ $nota->nota_examen2}}</td>
                                                    <td>{{ $nota->nota_examen3}}</td>
...
$(document).ready(function(){
  ...
  table.on('click', '.edit', function(){
    ...
    console.log(data);
    $('#est_id').val(data[1]);
    $('#nota_examen1').val(data[3]);
    $('#nota_examen2').val(data[4]);
    $('#nota_examen3').val(data[5]);
    $('#nota_final').val(data[6]);
...
$(document).ready(function(){
  ...
  table.on('click', '.delete', function(){
    ...
    console.log(data);
    $('#est_id1').val(data[1]);
    $('#nota_examen11').val(data[3]);
    $('#nota_examen21').val(data[4]);
    $('#nota_examen31').val(data[5]);
    $('#nota_final1').val(data[6]);
