                            ...
                            <tbody>
                              ...
                              <tr>
                                  ...
                                  @else
                                    ...
                                    <td class="">
                                      <button class="btn btn-secondary">&nbsp;No hay nada que validar</button>
                                    </td>
                                  @endif
                              </tr>
                          @endforeach
    ...
    <script type="text/javascript">
      $(document).ready(function(){
          ...
          table.on('click', '.edit', function(){
              ...
              $("#e_image_comprobante").attr("href", "\\ebid\\public\\assets\\img\\comprobantes\\" + data[3]);
              $("#e_img_image_comprobante").attr("src", "\\ebid\\public\\assets\\img\\comprobantes\\" + data[3]);
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            table.on('click', '.validate', function(){
                ...
                var data = table.row($tr).data();
                $("#image_comprobante").attr("href", "\\ebid\\public\\assets\\img\\comprobantes\\" + data[3]);
                $("#tipo_comp").val(data[2]);
                $("#telefono").val(data[5]);
                $("#name").val(data[1]);
                $("#tip_comp").text("Esta seguro de validar el comprobante de '"+data[2]+"' del estudiante '"+data[1]+"'");
                $("#img_image_comprobante").attr("src", "\\ebid\\public\\assets\\img\\comprobantes\\" + data[3]);
