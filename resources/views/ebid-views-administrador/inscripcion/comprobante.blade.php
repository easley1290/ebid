                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <select class="form-select form-control" name="e2_tipo_comprobante" id="e2_tipo_comprobante" required>
                            ...
                            <option value="inscripcion" disabled>Comprobante de INSCRIPCION</option>
                        </select>
                        </div>
                    </div>
                    <div class="modal-footer">
      ...
      $(document).ready(function(){
        ...
        table.on('click', '.delete', function(){
            ...
            var data = table.row($tr).data();
                $("#d_image_comprobante").attr("href", data[3]);
                $("#d_tipo_comp").val(data[2]);
                $("#d_telefono").val(data[5]);
                $("#d_name").val(data[1]);

                $("#d_tip_comp").text("Esta seguro de eliminar el comprobante de '"+data[2]+"' del estudiante '"+data[1]+"'");

                $("#d_img_image_comprobante").attr("src", data[3]);
                $('#delete').modal('show');
                $('#deleteForm').attr('action', 'comprobante/'+data[4]);
        })
      });
    </script>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            table.on('click', '.edit', function(){
                ...
                $("#e_image_comprobante").attr("href", data[3]);
                $("#e_img_image_comprobante").attr("src", data[3]);
                $("#e_tipo_comprobante option[value='"+data[2]+"']").attr("selected", true);
                $('#edit').modal('show');
                $('#editForm').attr('action', 'comprobante/'+data[4]);
            })
        });
    </script>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            table.on('click', '.validate', function(){
                ...
                var data = table.row($tr).data();
                $("#image_comprobante").attr("href", data[3]);
                $("#tipo_comp").val(data[2]);
                $("#telefono").val(data[5]);
                $("#name").val(data[1]);
                $("#tip_comp").text("Esta seguro de validar el comprobante de '"+data[2]+"' del estudiante '"+data[1]+"'");
                $("#img_image_comprobante").attr("src", data[3]);

                $('#validate').modal('show');
                
                $('#validateForm').attr('action', 'valida-comprobante/'+data[4]);
                ...
                $('#validarComp').click(function() {
                    ...
                    $url = 'https://web.whatsapp.com/send?phone=591'+data[5]+'&text='+$mensaje+'&app_absent=0';
